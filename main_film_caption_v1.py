...
# data_path_in = '/home/ljc/mywork/corpus/dailymail_20170307/bin_data_dailymail_training'
# vocab_path_in = '/home/ljc/mywork/textsum/data/vocab_data_dm_tr'
...
article_key_in = 'article'
abstract_key_in = 'abstract'
data_path_in = data_file#'data/data'
vocab_path_in = vocab_file#'data/toy_data_vocab'
log_root_in = 'log_root'
train_dir_in = 'log_root/train'
eval_dir_in = 'log_root/eval'
decode_dir_in = 'log_root/decode'
...
tf.app.flags.DEFINE_string('data_path',
                           data_path_in, 'Path expression to tf.Example.')
tf.app.flags.DEFINE_string('vocab_path',
                           vocab_path_in, 'Path expression to text vocabulary file.')
tf.app.flags.DEFINE_string('article_key', article_key_in,
                           'tf.Example feature key for article.')
tf.app.flags.DEFINE_string('abstract_key', abstract_key_in,
                           'tf.Example feature key for abstract.')
tf.app.flags.DEFINE_string('log_root', log_root_in, 'Directory for model root.')
tf.app.flags.DEFINE_string('train_dir', train_dir_in, 'Directory for train.')
